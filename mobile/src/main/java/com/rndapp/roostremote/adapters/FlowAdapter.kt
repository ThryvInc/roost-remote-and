...
class FlowAdapter(private val flows: List<Flow>, private val listener: OnItemClickedListener,
                  private val longListener: OnItemLongClickedListener? = null) : RecyclerView.Adapter<FlowAdapter.FlowHolder>() {
    ...
    class FlowHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
